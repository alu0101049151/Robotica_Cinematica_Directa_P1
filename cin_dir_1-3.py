...
if len(sys.argv) != nvar+1:
  sys.exit('El número de articulaciones no es el correcto ('+str(nvar)+')')  # nvar es el número de variables que vamos a utilizar
...
T12=matriz_T(d[1],th[1],a[1],al[1]) # Matriz del sistemas de transformación 
T02=np.dot(T01,T12)
...
muestra_origenes([o00,o10,o20,o30,o40,[[o51],[o52]]],oef0)
